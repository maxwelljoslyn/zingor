...
You can only add, replace, or remove a picture on a character you own. Other players' sheets show their pictures, but not the controls.

Pictures are visible to signed-in players only. Like the rest of Zingor, a picture is served only to someone who has logged in, so a link to one is not usable by the public.

:::{note}
For now, a character's picture appears on its own sheet. It is not yet shown in the party list, the whole-party inventory, or your profile page's list of characters.
:::
